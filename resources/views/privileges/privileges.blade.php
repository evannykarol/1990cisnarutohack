<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>{{ 'PRIVILEGES ' | translate }}</h2>
        <ol class="breadcrumb">
            <li>
                <a ui-sref="index.main">{{ 'HOME ' | translate }}</a>
            </li>
            <li class="active">
                <strong>{{ 'PRIVILEGES ' | translate }}</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
...
<div class="wrapper wrapper-content animated fadeInRight" ng-controller="PrivilegesCtrl as showCase">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="row">
                        <div class="col-sm-12"><h2><b>{{ 'PRIVILEGES' | translate }}
